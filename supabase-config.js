...
(function(){
  ...
  css.textContent=`
    ...
    #madaCommentsOverlay .mada-comments-sheet{
    ...
    #madaCommentsOverlay .mada-comments-summary{
    ...
    #madaCommentsOverlay .mada-comments-list{
      padding:0 16px 92px!important;
      overflow:auto!important;
    }

    /* Each comment: avatar on the far right, text immediately beside it */
    #madaCommentsOverlay .mada-comment-row{
      display:flex!important;
    ...
    #madaCommentsOverlay .mada-comment-avatar{
    ...
    #madaCommentsOverlay .mada-comment-main{
      order:1!important;
    ...
    /* Bubble sits directly beside the avatar, not on the opposite side */
    #madaCommentsOverlay .mada-comment-bubble{
    ...
    #madaCommentsOverlay .mada-comment-name{
    ...
    #madaCommentsOverlay .mada-comment-author{
    ...
    #madaCommentsOverlay .mada-comment-text{
    ...
    #madaCommentsOverlay .mada-comment-time{
      color:#65676b!important;
      font-size:12px!important;
      margin-top:3px!important;
    }

    /* Actions span the comment width: reaction on LEFT, reply near center, menu on RIGHT */
    #madaCommentsOverlay .mada-comment-tools{
    ...
    #madaCommentsOverlay .mada-comment-like-wrap{
    ...
    #madaCommentsOverlay .mada-comment-like{
    ...
    #madaCommentsOverlay .reply-comment{
      position:absolute!important;
      left:50%!important;
      right:auto!important;
      top:1px!important;
    ...
    /* Reaction picker opens toward the LEFT like the reference */
    #madaCommentsOverlay .mada-reaction-picker{
      position:absolute!important;
      left:-3px!important;
      right:auto!important;
    ...
    #madaCommentsOverlay .mada-reaction-choice{
    ...
    /* Bottom composer */
    #madaCommentsOverlay .mada-comment-compose{
      position:absolute!important;
      left:0!important;
      right:0!important;
      bottom:0!important;
    ...
    #madaCommentsOverlay .mada-comment-compose input{
      width:100%!important;
    ...
    @media(prefers-color-scheme:dark){
      #madaCommentsOverlay .mada-comments-sheet,
      #madaCommentsOverlay .mada-comments-summary,
      #madaCommentsOverlay .mada-comment-compose{background:#171d27!important;color:#f5f7fa!important}
      #madaCommentsOverlay .mada-comment-bubble{background:#252c37!important}
      #madaCommentsOverlay .mada-comment-name,
      #madaCommentsOverlay .mada-comment-text{color:#f5f7fa!important}
      #madaCommentsOverlay .mada-comment-time,
      #madaCommentsOverlay .mada-comment-tools button,
      #madaCommentsOverlay .mada-comment-like-count{color:#aab4c3!important}
      #madaCommentsOverlay .mada-comment-compose{border-color:#303846!important}
      #madaCommentsOverlay .mada-comment-compose input{background:#202731!important;color:#fff!important}
    }
  `;
