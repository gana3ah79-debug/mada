...
(function(){
  ...
  loadCss('mada-messenger-v1.css?v20260906-5','data-mada-messenger-v1');
  ...
  // Mada Messenger v1 is now the single active Messenger UI. The old v2 bridge
  // used to compete for msgBtn/msgBtn2 and could open a different modal.
  load('mada-messenger-v1.js?v20260906-5','data-mada-messenger-v1');
  load('mada-messenger-click-fix-v1.js?v20260906-4','data-mada-messenger-click-fix-v1');
