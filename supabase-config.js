...
/* Mada: robust Supabase bootstrap. Some mobile/Brave setups block one CDN; try several UMD mirrors synchronously before app/auth boot. */
(function(){
...
/* Auth is intentionally booted before app.js so a broken feature script cannot disable login. */
(function(){if(document.querySelector('script[data-mada-auth-early]'))return;document.write('<script src="auth-modern.js?v=20260904-17" data-mada-auth-early="1"></script>')})();
(function(){if(document.querySelector('link[data-mada-auth-shield-css]'))return;const c=document.createElement('link');c.rel='stylesheet';c.href='auth-click-shield.css?v=20260904-05';c.dataset.madaAuthShieldCss='1';document.head.appendChild(c);const s=document.createElement('script');s.src='auth-click-shield.js?v=20260904-05';s.async=false;s.dataset.madaAuthShield='1';document.head.appendChild(s)})();
(function(){if(document.querySelector('script[data-mada-startup-recovery]'))return;const s=document.createElement('script');s.src='startup-recovery.js?v=20260904-02';s.async=false;s.dataset.madaStartupRecovery='1';document.head.appendChild(s)})();
(function(){if(document.querySelector('script[data-mada-auth-stability]'))return;const s=document.createElement('script');s.src='auth-stability-fix.js?v=20260903-02';s.async=false;s.dataset.madaAuthStability='1';document.head.appendChild(s)})();
(function(){window.openMessages=window.openMessages||function(){if(typeof window.madaMessenger==='function')return window.madaMessenger();if(typeof window.showMessages==='function')return window.showMessages()}})();
