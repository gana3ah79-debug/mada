/* Mada Reels Fullscreen v2 — CSS fullscreen only, clean Android exit, no double-tap conflict */
(function(){'use strict';
...
function close(fromPop){var r=root();if(!r)return;cleanup();if(pushed&&!fromPop){pushed=false;try{history.back()}catch(_){}}else pushed=false;}
