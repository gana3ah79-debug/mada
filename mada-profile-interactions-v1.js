/* Mada Profile Interactions v1 — one delegated controller for visible profile buttons. */
(function(){'use strict';
if(window.__MADA_PROFILE_INTERACTIONS_V1)return;window.__MADA_PROFILE_INTERACTIONS_V1=true;
...
if(b.id==='mfpPostMenu'||b.classList.contains('fb-post-more')){e.preventDefault();e.stopPropagation();if(own())toast('إدارة المنشور متاحة من قائمة المنشورات.');else toast('خيارات المنشور غير متاحة للزوار.');return}
