(()=>{
 ...
 function loadActionsFix(){if(window.MadaProfileActionsFix)return;const s=document.createElement('script');s.src='profile-actions-fix.js?v=20260902-1';s.onload=()=>window.MadaProfileActionsFix?.wire?.();document.body.appendChild(s)}
 function wire(page){
